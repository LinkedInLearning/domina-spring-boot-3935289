...
public class VerduleriaRestTests {
	...
	void consultarVerduras() {
        ...
        ResponseEntity<String> response = restTemplate.exchange("/verduras", HttpMethod.GET, new HttpEntity<>(headers), String.class);
	...
	void consultarTomateTest() {
        ...
        ResponseEntity<String> response = restTemplate.exchange("/verduras/2001", HttpMethod.GET, new HttpEntity<>(headers), String.class);
	...
	void crearRemolachaTest() {
        HttpHeaders headers = loguear();     
		Verdura remolacha = new Verdura(0, "Remolacha", 4.52, false, null);

		HttpEntity<Verdura> requestEntity = new HttpEntity<>(remolacha, headers);
        ResponseEntity<Verdura> createResponse = restTemplate.exchange("/verduras", HttpMethod.POST, requestEntity, Verdura.class);
        ...
        ResponseEntity<String> getResponse = restTemplate.exchange(
        		remolachaLocation, HttpMethod.GET, new HttpEntity<>(headers), String.class);
